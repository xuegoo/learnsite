...
namespace LearnSite.DAL
{
	...
	public class Works
	{
       ...
       /// <returns></returns>
        ...
        {
            string strWhere = " Wtype='sb2' and Wurl is not null";
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT Wid,Wtype,Wscore,Wyear,Wgrade,Wclass,Wname,Wurl,Wthumbnail,Wtitle,Wdate FROM ( ");
