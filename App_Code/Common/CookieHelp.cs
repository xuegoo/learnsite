    ...
    public class CookieHelp
    {
        ...
        public static bool SetStuCookie(LearnSite.Model.Students stmodel, string LoginIp)
        {
            if (stmodel != null)
            {
                ...
                StuCookie.Expires = DateTime.Parse(StudentCookiesPeriod(str));
                StuCookie.Path = "/";
        ...
        public static void EditCookiesItem(string cookiesName, string itemName, string newValue)
        {
            ...
            if (cok != null)
            {
                ...
                if (str != "0")
                {
                    cok.Expires = DateTime.Parse(StudentCookiesPeriod(str));
                }
        ...
        private static string StudentCookiesPeriod(string str)
        {
