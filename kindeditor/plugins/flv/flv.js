...
KindEditor.plugin('flv', function (K) {
    ...
    self.plugin.flv = {
        edit: function () {
			...
			//autostart
				'<div class="ke-dialog-row">',
				'<label style="width:60px;">隐藏</label>',
				'<input type="checkbox" id="keAutostart" name="autostart" value="" /> ',
				'</div>',
            //mp4,flv格式
				'<div class="ke-dialog-row">',
				'注明: 最佳格式为mp4（视频编码AVC H264），文件名将自动转为拼音.<br/>',
            ...
            var dialog = self.createDialog({
                ...
                yesBtn: {
                    ...
                    click: function (e) {
                        ...
                        var html = [
					    '<img  id="showhide' + haomiao + '" src="../kindeditor/themes/default/flvshow.gif" alt="显示/隐藏视频" />\r\n',
                        '<div id="divarea'+haomiao+'" style="background-color:#666666;display:'+ autohide + ';width:' + width + 'px;height:' + height + 'px;" >\r\n',
                        '<a id="' + divplayer + '"></a>\r\n',
						'<script  type="text/javascript">$(document).ready(function () {\n',
						'$("#showhide'+haomiao+'").click(function () { $("#divarea'+haomiao+'").toggle(); });});</script>\n',							
