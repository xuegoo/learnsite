...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        .divcate{margin:auto; padding: 2px; background-color: #E0ECFE; font-size: 9pt; font-weight: bold; text-align: left; height: 24px; width:400px;}
...
<body>
    ...
    <center>
      ...
      <div id="student">
<div class="left">
    <asp:DataList ID="DLCategory" runat="server" RepeatColumns="2" 
