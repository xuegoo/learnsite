...
<body style="padding-top:0px;">
    ...
    <div id="researchform"  runat="server" style="text-align: center; background-color: #FFFFD7;">
        ...
        在一整天学习生活的24小时内，你在以下各方面所花费的时间有多少，请根据实际情况，如实完成调查
        ：<br />
    <ul>
    ...
    调查列表:<br />
        <asp:GridView ID="GVresearch" runat="server" AutoGenerateColumns="False" 
            ...
            GridLines="Vertical" Width="98%" Font-Names="Arial" Font-Size="Medium">
            <AlternatingRowStyle BackColor="#CCCCCC" />
            <Columns>
                <asp:BoundField DataField="Sname" HeaderText="姓名">
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField HeaderText="学习时间" DataField="Rlearn" >
                <ItemStyle Height="24px" HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField HeaderText="锻炼时间" DataField="Rplay" >
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField HeaderText="睡觉时间" DataField="Rsleep" >
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField HeaderText="空闲时间" DataField="Rfree" >
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
            </Columns>
